...
public class StringUtil {
    /*
    This class will br used to create String Utility methods
     */
...
// palindrome means the String is the same forward abd backwards
    ...
    First character staring as uppercase and the rest
     */
